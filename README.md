...
<body>
    ...
    <main id="collection" class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            ...
            <div id="boys" class="ronik-card">
                <img src="https://lh3.googleusercontent.com/u/0/d/1FsQo0DfC6QUCNqrZVVy8mNvdJglLyETM" alt="Men Tee">
                <div class="p-8">
            ...
            <div id="girls" class="ronik-card border-l-4 border-[#FFD700]">
                <img src="https://lh3.googleusercontent.com/u/0/d/1s9qBXN2Vj941krVfKi5rjFxmPyK9nkUl" alt="Women Luxury">
                <div class="p-8">
            ...
            <div id="kids" class="ronik-card">
                <img src="https://lh3.googleusercontent.com/u/0/d/1nwGmVo7ih_x1GKrzKCQZgn2U_jwbMXzB" alt="Kids Tee">
                <div class="p-8">
                    ...
                    <p class="text-gray-600 text-sm font-medium mb-6">ছোট্ট সোনামণিদের জন্য আরামদায়ক ফ্যাব্রিক এবং মজার সব কার্টুন প্রিন্ট। টেকসই এবং স্কিন-ফ্রেন্ডলি ম্যাটেরিয়াল!.</p>
                    ...
                    <a href="https://wa.me/8801315295310?text=I want to buy Kids Cartoon Print Tee" class="btn-ronik w-full flex justify-center items-center gap-3">
                        <i class="fab fa-whatsapp"></i> BUY ON WHATSAPP
                    </a>
                </div>
            </div>
            ...
            <div class="ronik-card">
                <img src="https://lh3.googleusercontent.com/u/0/d/1bkMN8YWcRn8ytU5_DfSBQeTmcrQPnZZW" alt="Cargo">
                <div class="p-8">
            ...
            <div class="ronik-card overflow-hidden">
                <img src="https://lh3.googleusercontent.com/u/0/d/1oekBXy1g_N7kH9u5tqC8UFQQI3G4Ah0E" alt="Kids Set">
                <div class="p-8">
                    <span class="bg-green-100 text-green-700 text-xs px-3 py-1 rounded-full font-bold uppercase">Kids Special</span>
            ...
            <div class="ronik-card overflow-hidden">
                <img src="https://lh3.googleusercontent.com/u/0/d/1FsQo0DfC6QUCNqrZVVy8mNvdJglLyETM" alt="Brand Tees">
                <div class="p-8">
                    <span class="bg-blue-100 text-blue-700 text-xs px-3 py-1 rounded-full font-bold uppercase">New Arrival</span>
    ...
    <footer class="bg-black text-white py-16 mt-16 shadow-inner">
        <div class="container mx-auto px-6 text-center">
            ...
            <p class="mb-8 font-semibold italic text-[#FFD700]">আপনার স্টাইলকে করুন আরও আকর্ষণীয়! বিশ্বাস ও সবার সেরা ফ্যাশনে প্রিমিয়াম টাচ নিয়ে এলো Ronik Dress Collection।"</p>
            
            <div class="flex justify-center gap-10 text-4xl mb-10">
                <a href="https://www.facebook.com/share/17K3gvTwbY/" target="_blank" class="hover:text-blue-500 hover:scale-110 transition"><i class="fab fa-facebook"></i></a>
